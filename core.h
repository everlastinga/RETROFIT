...
// For ARS, the numbers of writes to each row are recorded by the counters. One quarter of the hottest rows are swapped with one quarter of the coldest rows every 1024 of writes.
#ifdef cai
